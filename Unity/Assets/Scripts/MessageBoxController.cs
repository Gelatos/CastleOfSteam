...
public class ADMessageBoxController : MonoBehaviour
{
...
////		Hide();
//		if (spriteBackground.Length > 0) {
//////			for(int i=0; i<spriteBackground.Length; i++)
//			transform.localPosition = Vector3.left * spriteBackground [0].localScale.x;
//		}
//	}
//	
//	#endregion
...
//		while (textboxHidden || (BaseGameController.Instance != null && BaseGameController.Instance.GamePaused)) {
//			yield return null;
//		}
//		
...
//							while (words[k] != "") {
//								if (BaseGameController.Instance == null || !BaseGameController.Instance.GamePaused) {
...
//		if (spriteBackground.Length > 0) {
//			for (int i=0; i<spriteBackground.Length; i++)
//				TweenAlpha.Begin (spriteBackground [i].gameObject, 0.25F, 0.0F);
//		}
...
//		if (spriteBackground.Length > 0) {
//			for (int i=0; i<spriteBackground.Length; i++)
//				TweenAlpha.Begin (spriteBackground [i].gameObject, 0.0F, 1.0F);
//		}
